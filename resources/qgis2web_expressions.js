...
function exp_VISTAGENERAL_1rule0_eval_expression(context) {
    // COMITE = 0 AND AFILIACION = 0

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('COMITE')  == 0) && (feature.get('AFILIACION')  == 0));
    } else {
        return ((feature.get('COMITE')  == 0) && (feature.get('AFILIACION')  == 0));
    }
}
...
function exp_VISTAGENERAL_1rule1_eval_expression(context) {
    // COMITE = 0 AND AFILIACION >= 1

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('COMITE')  == 0) && (feature.get('AFILIACION')  >= 1));
    } else {
        return ((feature.get('COMITE')  == 0) && (feature.get('AFILIACION')  >= 1));
    }
}
...
function exp_DISTRITOLOCAL16_2rule0_eval_expression(context) {
    // COMITE = 0 AND AFILIACION = 0
...
function exp_DISTRITOLOCAL16_2rule1_eval_expression(context) {
    // COMITE = 0 AND AFILIACION >= 1
...
function exp_DISTRITOLOCAL16_2rule2_eval_expression(context) {
    // COMITE >= 1 AND AFILIACION >= 1
...
function exp_DISTRITOLOCAL10_3rule0_eval_expression(context) {
    // COMITE = 0 AND AFILIACION = 0
...
function exp_DISTRITOLOCAL10_3rule1_eval_expression(context) {
    // COMITE = 0 AND AFILIACION >= 1
...
function exp_DISTRITOLOCAL10_3rule2_eval_expression(context) {
    // COMITE >= 1 AND AFILIACION >= 1
