...
var style_DISTRITOLOCAL10_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("SECCION") !== null) {
        ...
        function rules_DISTRITOLOCAL10_3(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_DISTRITOLOCAL10_3rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITOLOCAL10_3rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITOLOCAL10_3rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_DISTRITOLOCAL10_3(feature, value);
        ;
